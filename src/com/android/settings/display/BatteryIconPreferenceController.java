...
public class BatteryIconPreferenceController extends AbstractPreferenceController implements
        PreferenceControllerMixin, Preference.OnPreferenceChangeListener {

    private static final String KEY_BATTERY_ICON = "battery_icon";

    public BatteryIconPreferenceController(Context context) {
        super(context);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        boolean showIcon = (Boolean) newValue;
